...
if (customIntros && customIntros.length > 0) {
    ...
    document.getElementById('welcome-subtitle-scramble').textContent = "请在设置中添加开场动画";
        ...
        // 替换原来的 manageAutoSendTimer 为 scheduleAutoSend
        function scheduleAutoSend() {
            ...
            // 计算随机延迟（最小 5 秒，最大为设定分钟数对应的毫秒数）
            const maxDelayMs = (settings.autoSendInterval || 5) * 60 * 1000;
            const minDelayMs = 5000; // 至少 5 秒，避免过于频繁
